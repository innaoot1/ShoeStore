package com.example.trifonova_practica.data
import com.example.trifonova_practica.data.service.UserManagementService
...
object RetrofitInstance {
    const val SUBABASE_URL = "https://eutjdggizovibmzjavno.supabase.co"
